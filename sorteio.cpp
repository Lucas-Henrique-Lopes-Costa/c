...
int main(int argc, char* argv[]) {
  if ( argc < 4 ) {
    std::cerr << "Chamada inválida." << std::endl;
  ...
  if (not arquivoAlunos){
    cerr << "Arquivo de alunos não pode ser aberto" << endl << nomeArqAlunos << endl;
